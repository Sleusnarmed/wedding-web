        ...
        <div className={styles.pageContainer}>
          ...
          <div className={styles.gratitudeText}>
            ...
            <p className={styles.paragraph}>
              ...
              pensamos que al pasar el tiempo compartiríamos experiencias
              únicas, pláticas con muchas risas y música que saldría de nuestros
              corazones. <br />
              <br />
              Llegamos a descubrir que las cosas juntos eran más divertidas y
              llenas de amor, sabemos ahora que es el momento ideal para
              compartir esta nueva aventura de la mano de Dios; nos encantaría
              celebrar este único momento con la compañía de nuestra familia y
              mejores amigos.
            </p>
          ...
          <div className={styles.ubicationContainer}>
            ...
            <div className={styles.ubicationContainer__information}>
              <p>
                Por tu comodidad en este día tan importante requerimos que
                lleves un cojín o almohada para sentarte, en caso de requerir
                una silla favor de contactarnos. (Texto a verificar con Saraí)
                <br /> <br />
                Recepción & Fiesta:
                <br /> <br />
